...
void threed_cpp(Container &C, std::vector<Item> &Items) {
    ...
    for (int i = Items.size() - 1; i >= 0; i--) {
        ...
        Iarr[0] = {I.l, I.b, I.h, dim[0], dim[2], dim[1], true, I.stackable, nullptr, I.o};
        Iarr[1] = {I.l, I.b, I.h, dim[1], dim[2], dim[0], true, I.stackable, nullptr, I.o};
        Iarr[2] = {I.l, I.b, I.h, dim[0], dim[1], dim[2], true, I.stackable, nullptr, I.o};
        Iarr[3] = {I.l, I.b, I.h, dim[1], dim[0], dim[2], true, I.stackable, nullptr, I.o};
        Iarr[4] = {I.l, I.b, I.h, dim[2], dim[1], dim[0], true, I.stackable, nullptr, I.o};
        Iarr[5] = {I.l, I.b, I.h, dim[2], dim[0], dim[1], true, I.stackable, nullptr, I.o};
        ...
        if (options.size() > TREE_WIDTH) {
            options.resize(TREE_WIDTH, {greedy(C_old, Items, Items.size() - 1), C_old});
        }
    }
}
